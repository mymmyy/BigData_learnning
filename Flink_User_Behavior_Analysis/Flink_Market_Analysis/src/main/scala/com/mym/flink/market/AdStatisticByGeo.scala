...
object AdStatisticByGeo {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val adCountStream = adEventStream.keyBy(_.province)
      .timeWindow(Time.hours(1), Time.seconds(5))
      .aggregate(new AdCountAgg(), new AdCountResout())
  ...
  class AdCountResout() extends WindowFunction[Long, CountByProvince, String, TimeWindow]{
